...
from .utility_functions import plot_object_data, show_data
#+END_SRC
    ...
    """Tis object holds reservoir specific information.
      ...
      Example::
              ...
              Reservoir(name = "foo",      # Name of reservoir
                        ...
                        plot_transform = a function reference, optional (see below)
                        )
      ...
      this function can then be added to a reservoir as::
          ...
          hplus.plot_transform = phc
    
      Note, at present the plot_transform function will only take one
