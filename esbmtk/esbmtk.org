...
<ipython-input-1-3382b33e6392> in <module>
----> 1 class ReservoirGroup(esbmtkBase):
      2     """This class allows the creation of a group of reservoirs which share
      3     a common volume, and potentially connections. E.g., if we have two
      4     reservoir groups with the same reservoirs, and we connect them
      5     with a flux, this flux will apply to all reservoirs in this group.
