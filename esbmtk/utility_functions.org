...
** Problems with Panchucks data

I only get an isotope effect of 2.9 permil with 6800 Pg C at -22
permil. The effect on the ocean is smaller if use second assumption
(i.e., 2220 Pmol at -60). The overall effect is probably dependent on
how we setup the fluxes?

#+BEGIN_SRC ipython
from esbmtk import get_imass, get_delta

l1, h1 = get_imass(2200E15,-60,C.r)

l2, h2 = get_imass(68001E15,-22,C.r)
...
get_delta(ol1,oh1,C.r)
get_delta(ol2,oh2,C.r)
#+END_SRC
