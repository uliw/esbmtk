...
#+BEGIN_SRC ipython :tangle utility_functions.py
def create_reservoirs(bn: list, v: list, t: list, p: list, c: dict, M: any) -> None:
    """

    bn : list of box names e.g., ['surface', 'deep']
    t: list of box temperatures in C, e.g., [12, 0,]
    p: list of box pressures in bar, e.g., [5, 500]
    c: list of dicts with initial concentrations  for each reservoir
       and species e.g., [{PO4: Q_("2.1 umol/l"), DIC: Q_("2.1 mmol/l"))}]
       the arguments must be quantities!
...
def create_bulk_connections(ct: dict, los: list) -> None:
    ...
    los :list = list of species to include in connection
    """
