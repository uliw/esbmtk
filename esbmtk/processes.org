...
class VarDeltaOut(Process):
    ...
    def get_process_args(self, reservoir: Reservoir):
        ...
        flux_data = List()
        proc_const = List()
        res_data.append(List(self.flux.m))
        res_data.append(List(delta))
        res_data.append(List(reservoir.c))
        
        flux_data.append(List(self.flux.m))
        flux_data.append(List(self.flux.l))
        flux_data.append(List(self.flux.h))
        flux_data.append(List(self.flux.d))
        proc_const.append(float(reservoir.species.element.r))
        proc_const.append(float(0))
...
class ScaleFlux(Process):
    ...
    def get_process_args(self, reservoir: Reservoir):
        ...
        flux_data = List()
        proc_const = List()
        res_data.append(List(self.ref.m))
        res_data.append(List(reservoir.d))
        res_data.append(List(self.ref.m))
        ...
        flux_data.append(List(self.flux.d))
        proc_const.append(float(reservoir.species.element.r))
        proc_const.append(float(self.scale))
...
class Fractionation(Process):
    ...
    def get_process_args(self, reservoir: Reservoir):
        ...
        flux_data = List()
        proc_const = List()
        res_data.append(List(reservoir.m))
        res_data.append(List(reservoir.d))
        res_data.append(List(reservoir.c))
        ...
        flux_data.append(List(self.flux.d))
        proc_const.append(float(reservoir.species.element.r))
        proc_const.append(float(self.alpha))
        # res_data: list = [
        #     reservoir.m,
        #     reservoir.d,
        #     reservoir.c,
