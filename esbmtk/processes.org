...
class GenericFunction(Process):
    ...
    Example: 
              GenericFunction(name = name of process,
                              act_on = name,
                              function  = f, 
                              a1 = a1, 
                              a2 = a2,
    ...
    Where: act_on is the name of the reservoir/flux this function should act upon, 
           function is the name of a user supplied function
           ai are optional function arguments. You only need to specify
           those ai you actually use.
    
    Towards this end, your function parameter list must be specified as
    
           def myfunc(i, a1=0, a2=0, a3=0, a4=0, a5=0, a6=0)

    where i is the current timestep, and ai are optional parameters,
    
    the function body is free to use or ignore any or all of the parameters

    the function return value must match the reservoir/flux __set__ method format

        return (m, l, h)
    
    where m = mass, and l and h are the masses of the light and heavy isotopes

    If l & h are not calculated, it is recommended to return dummmy values, e.g.,
