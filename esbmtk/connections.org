...
class Connect(esbmtkBase):
   ...
   - monod_type_limit: ref_value, a-value, b-value
    ...
    def __init__(self, **kwargs):
        ...
        if isinstance(kwargs["source"], str) or isinstance(
                kwargs["sink"], str):
            raise ValueError("Source/Sink must be handle, not a string!")
        elif (isinstance(kwargs["source"],
                         (ReservoirGroup, SourceGroup, SinkGroup))
              or isinstance(kwargs["sink"],
                            (ReservoirGroup, SourceGroup, SinkGroup))):
    ...
    def __init_group_connections__(self, kwargs):
        ...
        nor_sink = len(kwargs["sink"].names)
        nor_source = len(kwargs["source"].names)
        ...
        # list of variables which use a setter/getter and should
        # thus not be set directly
        self.drn = {
            "alpha": "_alpha",
            "rate": "_rate",
            "delta": "_delta",
        ...
        print(f"Created Connection Group {n}")
