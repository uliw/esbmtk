...
class Seawater(esbmtkBase):
    ...
    def __init__(self, **kwargs: Dict[str, str]):
        ...
        self.lrk: list = ["name"]
        # list of default values if none provided
        self.lod: Dict[str, any] = {"salinity": 35.0, "temperature": 25.0, "pH": 8.1}
    ...
    def __init_boron__(self) -> None:
        ...
        lnkb = (
            ...
            + 137.1942 * S ** 0.5
            + 1.62142 * S
            - (24.4344 + 25.085 * S ** 0.5 + 0.247 * S) * log(T)
            + 0.053105 * S ** 0.5 * T
        )
