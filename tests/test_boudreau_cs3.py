...
carbonate_system_3_pp(M.D_b, CaCO3_export, 200, 10999)
...
test_values = [  # result, reference value, tolerance, message
    ...
    (M.D_b2.DIC.c[-1] * 1e6, 82476.38738, tolerance, "M.D_b2.DIC.c[-1]"),
    # TA
    ...
    (M.D_b2.TA.c[-1] * 1e6, 164952.77476, tolerance, "M.D_b2.TA.c[-1]"),
    # pH
