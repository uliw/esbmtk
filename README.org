...
<<<<<<< HEAD
Note: ESBMTK 0.14.2.8 is a major update that now requires python 3.12 (released  Nov 6 2025). See the [[https://esbmtk.readthedocs.io/en/latest/changelog.html][Changelog]] for details.
=======
Note: ESBMTK 0.14.2.x is a major update that now requires python 3.12 (released  May 1^{st} 2025). See the [[https://esbmtk.readthedocs.io/en/latest/changelog.html][Changelog]] for details. The latest version is 0.14.2.8 (Nov. 6^{th} 2025)
>>>>>>> master
