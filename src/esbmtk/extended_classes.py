...
class Signal(esbmtkBase):
    ...
    def __write_data__(
        ...
        if self.isotopes:
            ...
            # light isotope
            df[f"{rn} {sp.ln} [{cmu}]"] = self.l[start:stop:stride]
...
class ExternalData(esbmtkBase):
    ...
    Note that the instance name will be a combination of the name specified
    ...
    def __init__(self, **kwargs: dict[str, str]):
        ...
        # Mapping to display units is now done by the plot routine!
        # if self.disp_units:
    ...
    def __plot__(edo, i, ax, axt="None") -> None:
        ...
        Note that the x-array data has been mapped into model time units
        upon import. So we need to remap into display time units first.
        """
        # Convert time and data to display units
