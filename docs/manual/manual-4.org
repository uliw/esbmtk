...
The function =create_gas_reservoirs_from_excel= can be used to read gas-reservoir definitions from an Excel worksheet. Each row describes one gas reservoir.
