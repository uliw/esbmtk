...
Note that in the following, we changed the species from DIC to C, to clarify that the isotope ratios are for organic matter, and not dissolved organic carbon. A correct model would have to account for the photosynthetic conversion from DOC to OM, followed by particulate transport, remineralization, as well as carbonate precipitation/dissolution. Nevertheless, the model demonstrates the isotopic  differentiation surface and deepwater.
#+name: po44_1
...
# boundary conditions
F_w_PO4 =  M.set_flux("45 Gmol", "year", M.PO4) # P @280 ppm (Filipelli 2002)
tau = Q_("1 month")  # PO4 residence time in surface box
F_b = 0.01  # About 1% of the exported P is buried in the deep ocean
thc = "20*Sv"  # Thermohaline circulation in Sverdrup
Redfield = 106 # C:P
#+END_SRC
