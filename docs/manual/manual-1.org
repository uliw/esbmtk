...
#+BEGIN_SRC org :noweb yes :exports none :tangle po_4_1_test.py
<<p1>>
<<p2>>
<<p3>>
<<p4>>
...
#+BEGIN_SRC jupyter-python :exports none :tangle test_po_4_1.py
import pytest
import po_4_1
...
def test_S_b(test_input, expected):
    t = 1e-12
    assert expected * (1 - t) <= test_input <= expected * (1 + t)
#+END_SRC
